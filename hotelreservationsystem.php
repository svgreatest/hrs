...
class hotelreservationsystem extends Module
{
    ...
    public function callInstallTab()
    {
        ...
        $this->installTab('AdminHotelEventCalendar', 'Add events', 'AdminHotelReservationSystemManagement');
        $this->installTab('AdminHotelReport', 'Report', 'AdminHotelReservationSystemManagement');
    ...
    public function deleteTables()
    {
        return Db::getInstance()->execute('
            ...
            `'._DB_PREFIX_.'htl_room_categories`,
            `'._DB_PREFIX_.'htl_event_calendar`');
    }
    ...
    public function callUninstallTab()
    {
        ...
        $this->uninstallTab('AdminHotelReservationSystemManagement');
        $this->uninstallTab('AdminHotelAddEventCalendar');
