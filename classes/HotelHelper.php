...
class HotelHelper
{
    ...
    public function insertHotelRoomsCategories()
    {
        $room_categories_arr = array('Online','Walk-in','Internal');
        foreach ($room_categories_arr as $key => $value) {
            $obj_room_info = new HotelRoomCategory();
            $obj_room_info->category = $value;
            $obj_room_info->save();
        }
    ...
    public static function isFestivalMode()
    {
