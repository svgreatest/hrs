...
CREATE TABLE IF NOT EXISTS `PREFIX_htl_room_information` (
  ...
  `id_category_normal` int(11) NOT NULL,
  `id_category_festival` int(11) NOT NULL,
  `date_add` datetime NOT NULL,
  `date_upd` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `PREFIX_htl_room_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `PREFIX_htl_event_calendar` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
